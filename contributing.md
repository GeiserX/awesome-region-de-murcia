# Contribuir a Awesome Región de Murcia
...
- El proyecto debe **dar soporte específico a la Región de Murcia** o incluir funcionalidades relevantes para usuarios en esta comunidad autónoma.
...
5. **Incluye en la descripción de la PR la URL del servicio, API o institución murciana** a la que el software da soporte (p.ej. carm.es, um.es, upct.es). Esto ayuda a verificar que el proyecto es relevante para la Región de Murcia.
