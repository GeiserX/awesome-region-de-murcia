...
1. Comprobar que el proyecto **da soporte específico a Región de Murcia** (no simplemente que el autor es de Región de Murcia).
2. Verificar que la PR incluye la **URL del servicio o institución de Región de Murcia** que el proyecto soporta.
...
4. Si el propietario del proyecto no ha sido notificado, abrir un issue de cortesía en su repo:
   - Título: `Incluido en awesome-region-de-murcia`
