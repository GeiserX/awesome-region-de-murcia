...
- [Eeutil-IGAE](https://github.com/carm-es/eeutil-igae) - Servicio de integración con la IGAE para la Suite InSiDE de la CARM.
...
- [Eeutil-PdfATools](https://github.com/carm-es/eeutil-pdfatols) - Conversión de documentos a formato PDF/A para la Suite InSiDE de la CARM.
...
- [Lotify](https://github.com/jcuervom/jc000001-lotify) - Bot de Telegram para monitorizar los lotes de cita de Extranjería en Murcia.
...
- [SANDRA](https://github.com/carm-es/sandra) - Sistema de gestión documental y expedientes electrónicos para la administración electrónica de la CARM.
...
- [Ateneo Molina de Segura](https://github.com/AteneoMolinaDeSegura/jekyll) - Sitio web del Ateneo Villa de Molina de Segura, asociación cultural de Molina de Segura.
...
- [Murcian Ipsum](https://github.com/klaufel/murcianipsum) - Generador de texto lorem ipsum basado en expresiones del dialecto murciano.
...
- [Wordle Panocho](https://github.com/arp-devs/wordle-panocho) - Juego Wordle con palabras en panocho, dialecto tradicional de la Huerta de Murcia.

## Datos Abiertos y Estadísticas

- [COVID-19 CARM](https://github.com/edumardo/covid19-carm) - Dataset de COVID-19 de la Región de Murcia extraído de fuentes oficiales de la CARM y MurciaSalud.
...
- [Basuraleza](https://github.com/MurciaLab/basuraleza) - Herramienta de ciencia ciudadana para mapear residuos geolocalizados en el municipio de Murcia.
...
- [Hydrotwin CHS](https://github.com/samuelSART/hydrotwin-v2) - Gemelo digital de la Confederación Hidrográfica del Segura con predicción de calidad del agua y simulación hidrológica.
- [IA Detector](https://github.com/Remdeht/ia_detector) - Detección de áreas de regadío en el Campo de Cartagena mediante Google Earth Engine e imágenes Sentinel.
...
- [ML ET0 Spain](https://github.com/yuye188/ML_ET0_Spain) - Modelos de aprendizaje automático para estimar evapotranspiración de referencia con datos IMIDA/SIAM de la Región de Murcia.
...
- [SMARTLAGOON AlLoRa](https://github.com/SMARTLAGOON/SMLG_AlLoRa) - Protocolo avanzado de transferencia LoRa para la red de monitorización ambiental del Mar Menor.
...
- [SMARTLAGOON CPR](https://github.com/SMARTLAGOON/SMLG_CPR) - Plugin QGIS de regresión de patrones de color para análisis de imágenes satelitales del Mar Menor.
- [SMARTLAGOON EC-T Track](https://github.com/SMARTLAGOON/SMLG_EC-T_Track) - Sistema ciudadano de bajo coste para monitorización de conductividad y temperatura del agua del Mar Menor.
- [SMARTLAGOON GIS Server](https://github.com/SMARTLAGOON/SMLG_GIS_SERVER) - Servidor GeoServer con visor OpenLayers para datos georreferenciados del Mar Menor.
- [SMARTLAGOON Remote Sensing](https://github.com/SMARTLAGOON/SMLG_RemoteSensingSoftware) - Descarga y procesamiento de datos satelitales NASA MODIS y ESA Sentinel-3 para el Mar Menor.
...
- [CMO SMS](https://github.com/iDoctor2000/CMO_SMS) - Cuadro de mandos de consultas realizadas por área y servicio del Servicio Murciano de Salud.
- [Murcia Solidaria](https://github.com/jmlweb/murciasolidaria) - Plataforma de gestión de solicitudes y entregas de material sanitario durante el COVID-19 en Murcia.
- [PUMA](https://github.com/iDoctor2000/PUMA) - Cuadro de mandos de urgencias en tiempo real para el Servicio Murciano de Salud.
- [SRNI](https://github.com/iDoctor2000/SRNI) - Aplicación Streamlit de soporte respiratorio no invasivo con integración de inteligencia artificial.
- [Surgery Obesity Arrixaca](https://github.com/iDoctor2000/surgeryobesity) - Sitio web del equipo de cirugía bariátrica del Hospital Virgen de la Arrixaca de Murcia.
- [UDI Portal](https://github.com/iDoctor2000/UDI-Portal) - Portal de interoperabilidad COMPAS para gestión de interconsultas entre las nueve áreas sanitarias del SMS.
...
- [Alicante-Murcia SUMO Scenario](https://github.com/jjgonde/Alicante-Murcia-SUMO-Scenario) - Escenario calibrado de simulación de tráfico SUMO para la autovía A-7 entre Alicante y Murcia.
...
- [Open GTFS Planner](https://github.com/KikeOnRails/open-gtfs-planner) - Planificador de rutas de transporte público con datos GTFS del tranvía de Murcia.
- [Parking Prediction Murcia](https://github.com/fterroso/mobility_murcia_umu_ucam) - Predicción de disponibilidad de aparcamiento en Murcia mediante deep learning con datos reales de parkings municipales.
- [PyBici](https://github.com/mgonzalezg9/PyBici) - Script Python para consultar estaciones y disponibilidad del sistema de bicicleta compartida MuyBici de Murcia.
- [Vías Verdes Murcia](https://github.com/clotitec/vias-verdes-murcia) - Mapa interactivo de las ocho vías verdes ciclistas de la Región de Murcia con rutas GPX y puntos de interés.
